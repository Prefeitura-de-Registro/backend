...
ticketRoutes.get("/", validateQuery(getManyTicketsQuerySchema), asyncHandler(ticketController.getMany));

ticketRoutes.get("/:id", validateParams(ticketIdParamsSchema), asyncHandler(ticketController.getById));

ticketRoutes.patch("/:id/assume", validateParams(ticketIdParamsSchema), asyncHandler(ticketController.assume));
