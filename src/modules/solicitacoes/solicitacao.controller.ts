...
import type { RespondSolicitacaoBodyDTO, SolicitacaoIdParamsDTO } from "./dtos/solicitacao.dto.js";
...
class SolicitacaoController {
  respond = async (request: Request, response: Response) => {
    ...
    const solicitacao = await solicitacaoService.respond(request.user!, id, body);
